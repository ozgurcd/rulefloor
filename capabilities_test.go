...
machine schemas: rulefloor.version.v1, rulefloor.validation.v1, rulefloor.capabilities.v1
...
commands: arm, capabilities, check, declare, help, init, list, prove, redproofs, rehash, repair-fixture-row, show, unarmed, unproved, validate, version
...
func TestCapabilitiesJSONMatchesV1Fixture(t *testing.T) {
	...
	want := binarycap.New("dev", []string{
		"arm", "capabilities", "check", "declare", "help", "init", "list", "prove",
